import os
os.environ["SPARK_HOME"] = "/workspaces/Real-time_Data_Streaming/spark-3.2.3-bin-hadoop2.7"
...
if __name__ == "__main__":
      ...
      df_station_informations = spark.read.csv("/workspaces/Real-time_Data_Streaming/stations_information.csv", header=True)
      ...
      def process_batch (df, epoch) : 
            ...
            for rows in postcodes : 
                  results_postcodes.append(rows["postcode"])
